...
function AdminState({ children }) {
  ...
  const createCollection = async (collection) => {
    const res = await Axios.post("/course/createCollection", collection, {
  ...
  const getCollection = async () => {
    const res = await Axios.get("/course/collection-list", {
      headers: { "x-auth-Debasis": token },
    });
    if (res.data.result === "Ok") {
      disPatch({
  ...
  const deleteCollections = async (collection) => {
    const res = await Axios.get("/course/deleteCollection", {
  ...
  const writeCourse = async (formData) => {
    const res = await Axios.post("/course/save/", formData, {
      headers: { "x-auth-Debasis": token },
    });
    if (res.data.result === "Ok") {
      toast.success(res.data.message);
  ...
  const getCourseData = async (collection) => {
    const res = await Axios.get("/course/getCourseData", {
      params: { collection: collection },
      headers: { "x-auth-Debasis": token },
    });
    if (res.data.result === "Ok") {
  ...
  const ShowEditData = async (collection, id) => {
    const res = await Axios.get("/course/getSelectedData", {
  ...
  const updateCourse = async (updateData,collection,id) => {
    const res = await Axios.put("/course/updateCourse",updateData, {headers: { "x-auth-Debasis": token }});
    if(res.data.result === "Ok"){
      toast.success(res.data.message);
  ...
  const deleteCourseData =async (collection,id) => {
      const res = await Axios.delete("/course/delete",{data:{collection:collection,id:id},headers: { "x-auth-Debasis": token }})
      if(res.data.result === "Ok"){
        toast.success(res.data.message);
